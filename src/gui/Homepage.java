    ...
    public Homepage() {
        ...
        loginButton.addActionListener(e -> {
            ...
            if(accountTypeDropdown.getSelectedItem() == "Employee") {
                ResultSet rs = dbM.query(String.format("SELECT email, password FROM Employee WHERE email = '%s' AND password = '%s';", email, password));
                if(rs != null) {
                    //new EmployeePage();
                }
                else {
                ...
                ResultSet rs = dbM.query(String.format("SELECT email, password FROM Customer WHERE email = '%s' AND password = '%s';", email, password));
                if(rs != null) {
